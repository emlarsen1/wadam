...
class LoginPage():
    ...
    def get_amazon_login(self):
        ...
        element = wait.until(EC.element_to_be_clickable(
            (By.XPATH, self.amazonlogin_button_xpath)))
        element.click()
    ...
    def enter_username(self, username):
        ...
        element = wait.until(EC.element_to_be_clickable(
            (By.XPATH, self.username_textbox_xpath)))
        element.send_keys(username)

        # Click the Sign in button
        element = wait.until(EC.element_to_be_clickable(
            (By.XPATH, self.username_button_xpath)))
        element.click()
    ...
    def enter_pincode(self, pincode):
        ...
        wait = WebDriverWait(self.driver, 30)
        element = wait.until(EC.element_to_be_clickable(
            (By.XPATH, self.pincode_textbox_xpath)))
        element.send_keys(pincode)

        # Click the Submit button
        element = wait.until(EC.element_to_be_clickable(
            (By.XPATH, self.pincode_button_xpath)))
        element.click()
